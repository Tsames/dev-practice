...
the same. Since it is impossible to change the length of the array in some languages, you must
instead have the result be placed in the first part of the array nums. More formally, if there are k
...
//Tests
console.log(`Test 1, Input is ${[1, 1, 2]}:`);
console.log(`Result: ${removeDuplicates([1, 1, 2])}`);

console.log(`Test 2, Input is ${[0, 0, 1, 1, 1, 2, 2, 3, 3, 4]}:`);
