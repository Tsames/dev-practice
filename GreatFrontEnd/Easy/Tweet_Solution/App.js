...
export default function App() {
  ...
  const thumbnail = "https://xsgames.co/randomusers/avatar.php?g=male"
  const name = "John Doe";
  const handle = "@johndoe";
  const message = "I got my wife a fridge for Christmas. I can't wait to see her face light up when she opens it.";
  const date = "Dec 25";
  const replyCount = 1094;
  const retweetCount = 5;
  const likeCount = 8402;
    ...
    <div className="tweet-body">
      ...
      <div>
        <div className="tweet-top-row">
          ...
          <span className="tweet-metadata">{handle} &middot; {date}</span>
        </div>
        ...
        <div className="tweet-action-row">
          <div className="tweet-action">
            ...
            <span className="tweet-action-count">{replyCount}</span>
          </div>
          <div className="tweet-action">
            <svg
              viewBox="0 0 24 24"
